 ...
 */
public class SearchForUserNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public SearchForUserNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
